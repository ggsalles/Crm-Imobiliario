-- ====================================================================
-- SCRIPT DE OTIMIZAÇÃO E CORREÇÃO FINAL: RESOLUÇÃO DE DEADLOCKS E SELF-LOCKS EM RLS
-- Sistema: SalesScore SaaS CRM
-- Objetivo: Ajustar as políticas RLS das tabelas 'profiles' e 'profile_tenants'
-- para remover quaisquer leituras recursivas ou PL/pgSQL na mesma tabela durante atualizações,
-- eliminando os bloqueios (locks) e timeouts que ocorrem ao alternar de imobiliária.
-- ====================================================================
...
-- 2. Vá até o painel do Supabase -> menu 'SQL Editor' -> 'New Query'.
-- 3. Cole o código e clique em 'Run'.
-- Isso otimizará as regras de segurança instantaneamente e resolverá todos os timeouts!
-- ====================================================================
